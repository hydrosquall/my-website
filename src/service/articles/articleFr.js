const article = `# Le guide des Bonnes Pratiques de Node.js, la plateforme logicielle, en basque
...
Au début,  j’ai cru que la traduction serait facile à réaliser de par mes 10 années d’expériences en tant que développeuse web et ma maîtrise parfaite du basque, ma langue maternelle. J’ai très vite réalisé que cela allait être plus long et difficile qu’imaginé: dans le monde informatique il existe beaucoup d’anglicismes qu’il n’est pas aisé de  traduire en basque. De plus, dans mon quotidien, je travaille en français et en anglais, et souvent mes phrases en basque sonnent un peu artificielles.

J’ai pensé arrêter le projet. C’était sans compter sur quelqu’un de plus têtu que moi, je parle de mon père, et j’ai changé d’avis. Il m’a encouragée à continuer, et pendant plusieurs mois, nous avons tous les deux travaillé sur la traduction. Nous avons formé et formons toujours un binôme imbattable: en combinant sa capacité à écrire en basque et mes connaissances techniques, nous avons réussi à effectuer la traduction du guide. Après un an et de nombreuses relectures, corrections, doutes … nous sommes fiers de cette publication. Et nous sommes heureux, car désormais des développeurs bascophones ont la possibilité d’utiliser un guide de ce niveau, en basque!
