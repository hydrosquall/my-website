...
Node.js is an open-source, cross-platform, back-end Javascript runtime environment, designed to build scalable web applications. In fact, Node.js is a very trendy development environment. More than 175.398 websites are built with Node.js.

Some of the most popular companies today use it: Linkedin, Netflix, Uber, Trello, PayPal, Nasa, Ebay, Medium, Groupon, Walmart, Mozilla, GoDaddy, Yandex, Citybank and Yahoo.
...
I noticed on Twitter that many developers from all around the world proposed their help to translate this guide into other languages. To tell the truth, I didn’t know about this guide, and it drew my attention. This is when I found out it is one of the most important and reputed existing open-source guides about Node.js, available on [the net](https://github.com/goldbergyoni/nodebestpractices/blob/master/README.md).
